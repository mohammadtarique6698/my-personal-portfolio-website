...
const EmailSection = () => {
  const emailAddress = "mohammadtarique661998@gmail.com";
  ...
  return (
    <section
      id="contact"
      className="grid grid-cols-2 my-12 md:my-12 py-24 gap-4 relative"
    >
      ...
      <div className="z-10">
        <h5 className="sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-600 mb-8">{`Let's Connect`}</h5>
      ...
      <div>
        <p className="text-[#ADB7BE]">
          I kindly request that you reach out to me via email at{" "}
          <span
          ...
          to avoid any potential inconvenience. Thank you.
        </p>
